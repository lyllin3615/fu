...
<table border="0" cellpadding="5" cellspacing="0" width="100%">	
	...
	<tr <?php echo ($k%2) ? "class='headerLineBackground'" : '';?>>
		...
		<td widtd="25%" align="center"><?php echo mb_substr($v['article_title'], 0, 8) . ' ... '; ?></td>
		<td widtd="25%" align="center"><?php echo $v['article_headline'] ? mb_substr($v['article_headline'],0,8) . '...' : ''; ?></td>
